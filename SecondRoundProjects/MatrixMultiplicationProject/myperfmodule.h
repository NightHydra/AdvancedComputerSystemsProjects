...
inline perf_t global_perf;
inline LARGE_INTEGER start_perf_counter, end_perf_counter, false_freq_start, false_freq_end;
inline long long endtimestamp, starttimestamp;
